...
export const metadata: Metadata = {
  ...
  description:
    "Reddy, Kamma, Kapu, Velama, Vysya, Brahmin, Yadav, Mala, Madiga, Lambada… 43 caste-wise Telugu matrimony channels. Bride & groom profiles, WhatsApp interest model. మనవివాహం (Manavivaha).",
