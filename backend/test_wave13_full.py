...
check("A8 verdict telugu 🚫+kudadhu", "🚫" in c["verdict_telugu"] and "kudadhu" in c["verdict_telugu"])
...
check("B4 CTA intact", "/unlock TSAP-F-2025-5775" in cap and "mosam jagratha" in cap.lower())
