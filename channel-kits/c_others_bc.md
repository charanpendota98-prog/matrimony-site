...
- **Key:** `c_others_bc`  •  **Tier:** L3_CASTE  •  **Wave:** 3  •  **Status:** create ⬜
- **Username:** `@manavivaha_others_bc` (already taken? → @tsap_others_bc, @manavivaha_others_bc_community)
- **Link:** https://t.me/manavivaha_others_bc
- **Hashtags:** #OthersBc #Bride #Groom #TS #AP
- **DP image:** `/home/user/matrimony-site/backend/channel_assets/c_others_bc.png`
...
```
📜 *CHANNEL RULES — 💍 Others Bc Matrimony | ఇతర BC కులాలు వివాహాలు*
━━━━━━━━━━━━━━━━━━
...
👉 Join: https://t.me/manavivaha_others_bc
...
```bash
python setup_channels.py --apply --key c_others_bc
```
