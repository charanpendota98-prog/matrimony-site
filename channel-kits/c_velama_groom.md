...
- **Key:** `c_velama_groom`  •  **Tier:** L3_CASTE  •  **Wave:** 1  •  **Status:** create ⬜
- **Username:** `@manavivaha_velama_groom` (already taken? → @tsap_velama_groom, @mv_velama_grm, @manavivaha_velama_grm)
